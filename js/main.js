...
var mymap = L.map('mapid', {
	...
	zoom: 16,
	layers: [Esri_WorldImagery], // [Stadia_AlidadeSmooth, Stadia_AlidadeSmoothDark, Esri_WorldImagery]
...
function next_route(){
		...
		route_list[route_index].setStyle({color: "red", opacity: 0.8});
