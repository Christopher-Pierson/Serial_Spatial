...
var mymap = L.map('mapid', {
	center: [39.3154161678816, -76.73439502716066],
	zoom: 17,
...
var woodlawn_owings_route = L.polyline(woodlawn_owings.features.map(feature => [feature.geometry.coordinates[1],feature.geometry.coordinates[0]])).bindPopup("<p>Trip 1:<b> Woodlawn to Owings Mill Lenscrafters</b><br>Distance:<b> 10.3 miles, 14 minutes</b></p>"); // 10.3 miles, 14 minutes
var owings_campfield_route = L.polyline(owings_campfield.features.map(feature => [feature.geometry.coordinates[1],feature.geometry.coordinates[0]])).bindPopup("<p>Trip 2:<b> Lenscrafters to Campfield</b><br>Distance:<b> 8 miles, 13 minutes</b></p>"); // 8 miles, 13 minutes

// create list of routes
var route_list = [
		woodlawn_owings_route,
		owings_campfield_route
];
...
var popup = L.popup()
    .setLatLng([39.315371, -76.734422])
    .setContent("Where did Hae go after leaving school?")
    .openOn(mymap);
