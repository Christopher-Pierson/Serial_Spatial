...
var i70_patrick_route = L.polyline(i70_patrick.features.map(feature => [feature.geometry.coordinates[1],feature.geometry.coordinates[0]])).bindPopup("<p>Trip 7:<b> I-70 Park-and-Ride to Patrick's</b><br>Distance:<b> 2.3 miles, 7 minutes</b></p>"); // 2.3 miles, 7 minutes
var patrick_forestpark_route = L.polyline(patrick_forestpark.features.map(feature => [feature.geometry.coordinates[1],feature.geometry.coordinates[0]])).bindPopup("<p>Trip 8:<b> Patrick's to Forest Park Neighborhood</b><br>Distance:<b> 4.2 miles, 12 minutes</b></p>"); // 4.2 miles, 12 minutes
var forestpark_woodlawn_route = L.polyline(forestpark_woodlawn.features.map(feature => [feature.geometry.coordinates[1],feature.geometry.coordinates[0]])).bindPopup("<p>Trip 9:<b> Forest Park to Track Practice</b><br>Distance:<b> 3.4 miles, 8 minutes</b></p>"); // 3.4 miles, 8 minutes
...
var leakin_lot_route = L.polyline(leakin_lot.features.map(feature => [feature.geometry.coordinates[1],feature.geometry.coordinates[0]])).bindPopup("<p>Trip 14:<b> Leakin Park to Residential Lot</b><br>Distance:<b> 2.4 miles, 8 minutes</b></p>"); // 2.4 miles, 8 minutes
...
var jay_superfresh_route = L.polyline(jay_superfresh.features.map(feature => [feature.geometry.coordinates[1],feature.geometry.coordinates[0]])).bindPopup("<p>Trip 17:<b> Jay's to Super Fresh Halal Market</b><br>Distance:<b> 1.1 miles, 4 minutes</b></p>"); // 1.1 miles, 4 minutes
...
var route_list = [
	...
	bb_i70_route,
	i70_patrick_route,
	patrick_forestpark_route,
	forestpark_woodlawn_route,
